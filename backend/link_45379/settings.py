"""
Django settings for link_45379 project.
...
WSGI_APPLICATION = 'link_45379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "link_45379 API",
    "DESCRIPTION": "API documentation for link_45379 App",
    "VERSION": "v1",
}
